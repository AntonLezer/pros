...
export default function ViberIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 72.214497 76.209872" aria-hidden="true" {...props}>
      <g transform="translate(-429.26705,-345.04681)">
        <path
          fill="currentColor"
