      ...
      <div className="mx-auto max-w-[1200px] px-5 md:px-8">
        <div className="mx-auto max-w-[900px] text-center">
          ...
          <p className="mx-auto mt-4 max-w-[600px] text-[16px] leading-relaxed text-muted">
            Ми знімаємо страх перед стоматологом. Подивіться, як виглядає лікування зубів у
            Хмельницькому у нашій клініці — затишна атмосфера, сучасне обладнання для чистки,
            відбілювання та імплантації, уважні лікарі.
          </p>
